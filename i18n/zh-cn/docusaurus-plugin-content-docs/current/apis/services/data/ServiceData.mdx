...
### <IconObjType type="method"/> `register_request` {#-register_request}
...
|         参数         |                                         类型                                          |               必选                | <center>说明</center>                                                      |
| :------------------: | :-----------------------------------------------------------------------------------: | :-------------------------------: | -------------------------------------------------------------------------- |
|        `url`         | <code>{`str \| `}[urllib.parse.ParseResult<IconExternalLink/>][link-parsedurl]</code> | <InlineIcon icon={vsiCheckIcon}/> | 指向远端文件的字符串类型、或解析过的 URL。                                 |
...
### <IconObjType type="param"/> `allowed_cross_origin` {#-allowed_cross_origin}
...
[link-parsedurl]: https://docs.python.org/zh-cn/3/library/urllib.parse.html#urllib.parse.ParseResult
