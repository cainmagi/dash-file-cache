...
| :---------------------------------------------------------------: |
| ![Example of the downloader](./static/example-download-file.webp) |
...
The second argument is the address of the cached data. This callback has two special
...
This callback simulate the process of validating the address. The results will be
...
accept the file address by using `to_addr(...)` to sanitize this callback value.
