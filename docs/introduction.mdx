...
|                                                                The minimal demo                                                                 |
| :---------------------------------------------------------------------------------------------------------------------------------------------: |
| <img alt="demo-minimal" className="ondark-inv" src="https://raw.githubusercontent.com/cainmagi/dash-file-cache/main/display/demo-minimal.png"/> |
...
<p>
  {
    <DarkButton
      to="https://github.com/cainmagi/dash-file-cache/blob/main/Changelog.md"
      icon={octClock16}
    >
      Changelog
    </DarkButton>
...
<p>
  {
    <DarkButton
      to="https://github.com/cainmagi/dash-file-cache/blob/main/LICENSE"
      icon={octLaw16}
    >
      GPL v3 License
    </DarkButton>
...
<p>
  {
    <DarkButton
      to="https://github.com/cainmagi/dash-file-cache/blob/main/CONTRIBUTING.md"
...
<p>
  {
    <DarkButton
      to="https://github.com/cainmagi/dash-file-cache/blob/main/CODE_OF_CONDUCT.md"
...
<p>
  {
    <DarkButton
      to="https://github.com/cainmagi/dash-file-cache/blob/main/SECURITY.md"
      icon={octiconShield16}
    >
      Security
    </DarkButton>
  }
